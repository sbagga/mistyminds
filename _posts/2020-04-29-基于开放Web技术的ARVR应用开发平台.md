...
和web开发者生态的对接和内容适配对AR应用更为关键，因为AR本质上是一个外化的互联网，数字的互联网的内容需要投射到这个新的物理互联网上。
 ...
 ![enter image description here](https://mistyminds.github.io/mistyminds/images/unity-integration.png)
...
下图是当前web平台上的AR/VR应用开放平台的一个架构图，包括一些头部的开源项目
 ![enter image description here](https://raw.githubusercontent.com/mistyminds/mistyminds/master/images/webXR-Architecture.png)
...
![enter image description here](https://mistyminds.github.io/mistyminds/images/webXR-integration.png)
...
这种做法的优点是
 ...
 有两种可以考虑的实现方式
 ![enter image description here](https://mistyminds.github.io/mistyminds/images/webXR-wasm-integration-1.png)
 
这种方式需要在平台安装和运行AR/VR Engine

![enter image description here](https://mistyminds.github.io/mistyminds/images/webXR-wasm-integration-2.png)
...
![enter image description here](https://mistyminds.github.io/mistyminds/images/Two-WebXR-Architecture.png)
